                ...
                <div className="row row-cols-1 row-cols-md-2 g-4">
                    <Link href="/cashout/vpa">
                        <div className="col pointer">
                            <div className="card border-0 text-bg-primary mb-3 h-100" >
                                <div className="card-header"><h5 className="text-white fw-bold">UPI Transfer</h5></div>
                    ...
                    <div className="col pointer">
                        <div className="card  border-0 h-100 text-bg-light mb-3" >
                            <div className="card-header"><h5 className="text-dark fw-bold">Bank Transfer</h5></div>
                            <div className="card-body my-4">
                                <p className="card-text">
